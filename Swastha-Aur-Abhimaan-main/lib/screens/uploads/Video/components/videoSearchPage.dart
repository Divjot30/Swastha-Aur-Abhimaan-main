...
import 'package:swastha_aur_swabhimaan/screens/uploads/Video/components/models/videoSearchTile.dart';
  ...
  searchVideo() async {
    if (searchController.text.isNotEmpty) {
      ...
      await DatabaseService()
          .searchVideoByTag(removeSpaceAndCapitalize(searchController.text))
          .then((snapshot) {
        setState(() {
    ...
    return hasUserSearched
        ? ListView.builder(
            ...
            itemBuilder: (context, index) {
              return VideoSearchTile(
                title: videoSnapshot!.docs[index]['videoTitle'],
                tag: videoSnapshot!.docs[index]['tag'],
                videoID: videoSnapshot!.docs[index]['videoID'],
              );
            })
        : Container();
  }
