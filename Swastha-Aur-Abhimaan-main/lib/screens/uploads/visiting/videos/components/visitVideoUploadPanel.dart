...
class VisitVideoUploadPanel extends StatefulWidget {
  const VisitVideoUploadPanel({Key? key}) : super(key: key);

  @override
  State<VisitVideoUploadPanel> createState() => _VisitVideoUploadPanelState();
}

class _VisitVideoUploadPanelState extends State<VisitVideoUploadPanel> {
