...
class SkillUploadPanel extends StatefulWidget {
  const SkillUploadPanel({Key? key}) : super(key: key);

  @override
  State<SkillUploadPanel> createState() => _SkillUploadPanelState();
}

class _SkillUploadPanelState extends State<SkillUploadPanel> {
